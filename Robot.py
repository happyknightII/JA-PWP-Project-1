...
class Robot:
    ...
    def indicate(self, index):
        for i in range(72):
            if i < index:
                self.strip.setPixel(index, (int(255 * i/index), int(255 * i/index), int(255 * i/index)))
            else:
                self.strip.setPixel(index, (int(255 * (72-i)/index), int(255 * (72-i)/index), int(255 * (72-i)/index)))
        self.strip.show()
